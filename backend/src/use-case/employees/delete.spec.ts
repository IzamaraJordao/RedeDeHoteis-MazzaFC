...
describe('Delete Employee',()=>{
    it ('Should delete an employee', async () => {
        ...
        await sut.execute({params:{id:employee.id}, body: undefined, query: undefined});
    ...
    it ('Should throw if any employee not founded', async () => {
        ...
        expect(sut.execute({params:{id:'new_id'}, body: undefined, query: undefined})).rejects.toThrow();
    })
